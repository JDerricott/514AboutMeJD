    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.jeff_derricott"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.jeff_derricott.tests.tests"

        To run tests in the JeffDerricottTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.jeff_derricott.tests.tests.JeffDerricottTestCase"

        To run only the test_if_tethys_platform_is_great function in the JeffDerricottTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.jeff_derricott.tests.tests.JeffDerricottTestCase.test_if_tethys_platform_is_great"
...
class JeffDerricottTestCase(TethysTestCase):
    """
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(JeffDerricott)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(JeffDerricott)
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/jeff-derricott/')  # The final '/' is essential for all pages/controllers
